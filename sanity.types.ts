...
// Source: lib/orders/getMyOrders.tsx
// Variable: MY_ORDERS_QUERY
// Query: *[_type == "order" && clerkUserId == $userId] | order(orderDate desc){        ...,        products[]{          ...,          // -> gets the product the reference is referring too          product->        }      }
export type MY_ORDERS_QUERYResult = Array<{
  ...
  currency?: string;
  amountDiscount?: number;
  status?: "cancelled" | "delivered" | "paid" | "pending" | "returned" | "shipped";
  orderDate?: string;
}>;

// Source: lib/products/getAllCategories.ts
...
// Source: lib/products/getAllProducts.ts
...
// Source: lib/products/getProductBySlug.ts
...
// Source: lib/products/getProductsByCategory.ts
...
// Source: lib/products/searchProductsByName.ts
...
// Source: lib/sales/getActiveSaleByCouponCode.ts
